...
const TOOL_LABEL_IN: Record<string, string> = {
  ...
  pick_candidates: "Eligiendo creators candidatos…",
  scrape_profiles: "Scrapeando perfiles en vivo…",
  cosine_match: "Cruzando ICP con creators…",
  match_influencers: "Cruzando ICP con creators…",
